...
},{"./settings":4}],2:[function(require,module,exports){
let Vue = require('vue');
...
},{"./router":3,"vue":13,"vue-router":12}],3:[function(require,module,exports){
...
},{"./../vue/itemlist.vue":7,"moment":9,"vue-router":12}],4:[function(require,module,exports){
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{staticClass:"date-items"},[_h('div',{staticClass:"numeric date-items-head"},[_vm._s(_vm.date)])," ",_h('ul',{staticClass:"items"},[_vm._l((_vm.items),function(item){return _h('li',{key:item.id,class:{selected: _vm.selected[item.id], editing: _vm.editing, submitting: _vm.submitting[item.id]},attrs:{"id":'item-' + item.id},on:{"click":function($event){_vm.selectSelf(item.id)}}},[_h('div',{staticClass:"item"},[(_vm.editors[item.id])?[_h('item-form',{attrs:{"id":'item-form-' + item.id,"tags":item.tags,"price":item.price,"date":item.date,"disabled":_vm.submitting[item.id]},on:{"dateChanged":function($event){_vm.dateChanged(item, $event)},"submit":function($event){_vm.submit(item, $event)}}})]:[_h('div',{staticClass:"tag-list"},[_vm._l((item.tags),function(tag){return _h('span',[_vm._s(tag)])})])," ",_h('span',{staticClass:"numeric price",class:{positive: item.price > 0}},["\n                        "+_vm._s(_vm._f("money")(item.price))+"\n                    "])]," "])," ",(_vm.deleting || _vm.editing)?_h('div',{staticClass:"button-group"},[(_vm.deleting)?_h('button',{staticClass:"i selected",class:{'i-check_box_outline_blank': !_vm.selected[item.id], 'i-check_box': _vm.selected[item.id]}}):_vm._e()," ",(_vm.editing)?_h('button',{staticClass:"i",class:{'i-mode_edit': !_vm.editors[item.id], 'i-close': _vm.editors[item.id]},on:{"click":function($event){_vm.editSelf(item.id, $event)}}}):_vm._e()," ",(_vm.editors[item.id])?_h('button',{staticClass:"i i-save",attrs:{"type":"submit","form":'item-form-' + item.id,"disabled":_vm.submitting[item.id]}}):_vm._e()]):_vm._e()])})])])}
...
},{"./../js/io":1,"./itemform.vue":6,"vue":13,"vue-hot-reload-api":11}],6:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('form',{staticClass:"item-form",on:{"submit":function($event){$event.preventDefault();_vm.submit($event)}}},[_h('tags',{attrs:{"choices":_vm.autocomplete,"tags":_vm.pTags,"disabled":_vm.disabled},on:{"blur":function($event){_vm.focusPrice()}}})," ",(!_vm.datehidden)?_h('input',{staticClass:"date numeric",attrs:{"type":"text","autocomplete":"off","placeholder":"Date","required":"","disabled":_vm.disabled},domProps:{"value":_vm.date},on:{"input":function($event){_vm.dateChanged($event.target.value)}}}):_vm._e()," ",_h('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.pPrice),expression:"pPrice"}],ref:"price",staticClass:"price numeric",attrs:{"type":"number","step":"0.01","autocomplete":"off","placeholder":"Price","required":"","disabled":_vm.disabled},domProps:{"value":_vm._s(_vm.pPrice)},on:{"input":function($event){if($event.target.composing){ return; }_vm.pPrice=_vm._n($event.target.value)}}})])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"./../js/io":1,"./tags.vue":8,"vue":13,"vue-hot-reload-api":11}],7:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{class:{loading: _vm.loading},attrs:{"id":"item-list"}},[(_vm.loading)?_h('div',{attrs:{"id":"loader"}}):_vm._e()," ",_h('div',{attrs:{"id":"title"}},[_h('div',{attrs:{"id":"year-month"}},[_vm._s(_vm.yearMonth)])," ",_h('div',{staticClass:"button-group main"},[_h('button',{staticClass:"i",class:{'i-mode_edit': !_vm.editing, 'i-close': _vm.editing, disabled: _vm.deleting},attrs:{"id":"edit","disabled":_vm.deleting},on:{"click":function($event){_vm.editing = !_vm.editing}}})," ",_h('button',{staticClass:"i",class:{'i-delete': !_vm.deleting, 'i-close': _vm.deleting, disabled: _vm.editing},attrs:{"id":"delete","disabled":_vm.editing},on:{"click":function($event){_vm.deleting = !_vm.deleting}}})])," ",_h('div',{staticClass:"h-fill"})," ",_h('div',{staticClass:"button-group navigation"},[(_vm.canNavigate)?_h('button',{staticClass:"i i-keyboard_arrow_left",on:{"click":function($event){_vm.seekMonth(-1)}}}):_vm._e()," ",(_vm.canNavigate)?_h('button',{staticClass:"i i-navigate_next",on:{"click":function($event){_vm.seekMonth(1)}}}):_vm._e()," ",(_vm.deleting)?_h('button',{staticClass:"i i-check",attrs:{"id":"delete-confirm"},on:{"click":function($event){_vm.deleteSelected()}}}):_vm._e()])])," ",_h('div',{attrs:{"id":"date-items-list"}},[_vm._l((_vm.dates),function(dateItems){return _h('date-items',{key:dateItems.date,attrs:{"date":dateItems.date,"items":dateItems.items,"deleting":_vm.deleting,"editing":_vm.editing},on:{"select":_vm.itemSelected,"itemChanged":function($event){_vm.itemChanged(dateItems, $event)}}})})])," ",_h('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.canNavigate),expression:"canNavigate"}],attrs:{"id":"main-item-form"}},[_h('item-form',{attrs:{"id":"item-form-0","date":_vm.today,"disabled":_vm.submitting},on:{"submit":_vm.submit,"dateChanged":_vm.dateChanged}})," ",_h('button',{staticClass:"i i-add",attrs:{"type":"submit","form":"item-form-0","disabled":_vm.submitting}})])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../js/io":1,"./dateitems.vue":5,"./itemform.vue":6,"moment":9,"vue":13,"vue-hot-reload-api":11}],8:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('ul',{staticClass:"tags",class:{conflict: _vm.conflict, empty: _vm.pTags.length, disabled: _vm.disabled},on:{"click":_vm.focusInput}},[_vm._l((_vm.pTags),function(tag){return _h('li',{key:tag,staticClass:"tag",on:{"click":function($event){_vm.remove($event, tag)}}},["\n        "+_vm._s(tag)+"\n    "])})," ",_h('li',{staticClass:"tag-input"},[_h('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.currentTag),expression:"currentTag"}],ref:"tagInput",attrs:{"disabled":_vm.disabled},domProps:{"value":_vm._s(_vm.currentTag)},on:{"keydown":_vm.keydown,"input":[function($event){if($event.target.composing){ return; }_vm.currentTag=$event.target.value},_vm.input],"blur":_vm.add}})," ",(_vm.choiceListVisible)?_h('ul',{ref:"choiceList",class:{dropup: _vm.dropup}},[_vm._l((_vm.pChoices),function(tag,index){return _h('li',{ref:"choices",refInFor:true,class:{'tag-choice-selected': index === _vm.selectedIndex},on:{"mousedown":function($event){_vm.deferBlur = true},"mouseup":function($event){_vm.add($event, tag)},"mouseover":function($event){_vm.selectedIndex = index}}},["\n                "+_vm._s(tag)+"\n            "])})]):_vm._e()])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"vue":13,"vue-hot-reload-api":11}],9:[function(require,module,exports){
//! moment.js
//! version : 2.17.1
